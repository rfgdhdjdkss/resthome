<template>
    <div class="header">
        <span class="back-arrow" @click="router.push({name:'PersonalCenter_app'})">←</span>
        <h4>收货地址</h4>
    </div>
    <div class="edit-profile-container">
        ...
        <div v-if="receiveAddressList">
            <div class="address-item" v-for="item in receiveAddressList"
                @click="gotoShippingAddressDetailPage(item.receiveAddressId)">
...
const gotoShippingAddressDetailPage = (addressid) => {
    router.push({
